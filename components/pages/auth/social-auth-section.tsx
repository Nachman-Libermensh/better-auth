...
export function SocialAuthSection({
  ...
  return (
    <div className="space-y-4 text-center">
      <div
        className="relative flex items-center gap-4 animate-in fade-in-0 slide-in-from-bottom-4 duration-500"
